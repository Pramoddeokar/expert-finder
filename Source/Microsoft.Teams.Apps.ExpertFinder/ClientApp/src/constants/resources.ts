...
export default class Resources {
	...
	//Profile Search 
	public static readonly MaxUserProfileLimit: number = 5;

	//Search Popup
	public static readonly SkillsValue: string = "skills";
	public static readonly interestsValue: string = "interests";
	public static readonly schoolsValue: string = "schools";

	//Task Module
	public static readonly UserSearchBotCommand: string = "search";
}